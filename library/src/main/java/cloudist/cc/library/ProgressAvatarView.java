...
public class ProgressAvatarView extends ImageView {
    ...
    public ProgressAvatarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ProgressAvatarView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void startAnim() {
        ...
        valueAnimator1.setDuration(3600);
        ...
        ValueAnimator valueAnimator2 = ValueAnimator.ofFloat(0, 150, 0);
        valueAnimator2.setDuration(2400);
        valueAnimator2.setRepeatCount(ValueAnimator.INFINITE);
        valueAnimator2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                mCover = (float) animation.getAnimatedValue();
                postInvalidate();
            }
        });

        animatorSet.setDuration(3600);
...
//        animatorSet.cancel();
//        ValueAnimator valueAnimator = ValueAnimator.ofFloat(mCover, 360);
